-- Base de datos para sistema académico de Secundaria (Media General / Media Técnica)
-- Instituto: Carabobo
SET SQL_MODE="NO_AUTO_VALUE_ON_ZERO";
START TRANSACTION;
SET time_zone = "-04:00";

DROP DATABASE IF EXISTS db_carabobo;
CREATE DATABASE db_carabobo DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE EXTRA_CURRICULAR (
    ...
    fecha_asignacion_canaima DATE,
    serial_canaima VARCHAR(100),
...
-- Grados de Secundaria (1er a 6to año)
INSERT INTO GRADO (nivel, nombre) VALUES
    ('Bachillerato', '1er Año'),
    ('Bachillerato', '2do Año'),
    ('Bachillerato', '3er Año'),
    ('Bachillerato', '4to Año'),
    ('Bachillerato', '5to Año');
