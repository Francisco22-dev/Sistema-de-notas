...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-09-2026 a las 20:30:25
...
--
-- Base de datos: `db_carabobo`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `antropometricos`
--
...
CREATE TABLE `antropometricos` (
  ...
  `talla_zapato` int(3) DEFAULT NULL
...
(2, 1, 'Seguridad', 'Intento de acceso bloqueado por mantenimiento programado (Usuario: admin)', 'DESKTOP-LLBMAGR', '2026-09-16 18:05:44'),
(3, 2, 'Mantenimiento', 'Mantenimiento ejecutado. Sistema abierto hasta: 16/03/2027 14:05', 'DESKTOP-LLBMAGR', '2026-09-16 18:06:08'),
(4, 2, 'Mantenimiento', 'Mantenimiento ejecutado. Sistema abierto hasta: 16/03/2027 14:05', 'DESKTOP-LLBMAGR', '2026-09-16 18:29:32');
...
CREATE TABLE `direccion` (
  ...
  `vereda` varchar(10) DEFAULT NULL,
  `numero_vivienda` varchar(20) DEFAULT NULL,
  `tipo_vivienda` enum('Casa','Edificio','Apartamento','Quinta','Rancho','Otro') NOT NULL,
...
CREATE TABLE `extra_curricular` (
  ...
  `cuales_deportes` varchar(255) DEFAULT NULL,
  `posee_canaima` enum('Si','No') NOT NULL DEFAULT 'No',
  `fecha_asignacion_canaima` date DEFAULT NULL,
  `serial_canaima` varchar(100) DEFAULT NULL,
  `estado_canaima` enum('Operativa','Dañada','Robada','En Reparacion') DEFAULT 'Operativa',
  `falla_canaima` text DEFAULT NULL,
  `posee_cargador` enum('Si','No') NOT NULL DEFAULT 'No',
  `estado_cargador` enum('Operativo','Dañado') DEFAULT 'Operativo',
  `falla_cargador` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
CREATE TABLE `grado` (
  `id` int(11) NOT NULL,
  `nivel` enum('Bachillerato') NOT NULL DEFAULT 'Bachillerato',
...
INSERT INTO `grado` (`id`, `nivel`, `nombre`) VALUES
(1, 'Bachillerato', '1er Año'),
(2, 'Bachillerato', '2do Año'),
(3, 'Bachillerato', '3er Año'),
(4, 'Bachillerato', '4to Año'),
(5, 'Bachillerato', '5to Año');
...
CREATE TABLE `inscripcion` (
  ...
  `nivel_academico` enum('Media General','Media Tecnica') NOT NULL DEFAULT 'Media General',
...
--
-- Estructura de tabla para la tabla `materia_profesor_periodo`
--
...
--
-- Estructura de tabla para la tabla `nota_lapso_periodo`
--

CREATE TABLE `nota_lapso_periodo` (
  `id` int(11) NOT NULL,
  `nombre` enum('1er lapso','2do lapso','3er lapso','Reparacion') DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `nota_periodo_inscripcion`
--
...
INSERT INTO `periodo_academico` (`id`, `nombre`, `ESTADO`, `create_at`) VALUES
(1, '2025-2026', 'Activo', '2026-08-11 14:42:08'),
(2, '2026-2027', 'Activo', '2026-08-11 14:42:08'),
(3, '2027-2028', 'Activo', '2026-08-11 14:42:08');
...
--
-- Estructura de tabla para la tabla `persona_representante`
--
...
CREATE TABLE `profesor` (
  `id` int(11) NOT NULL,
  `tipo_nivel` enum('Secundaria') NOT NULL DEFAULT 'Secundaria',
  `persona_id` int(11) NOT NULL,
...
CREATE TABLE `salud` (
  `id` int(11) NOT NULL,
  `reacciones_alergicas` enum('Si','No') NOT NULL,
  `cuales_alergias` text DEFAULT NULL,
  `enfermedades_padecidas` text DEFAULT NULL,
  `atencion_especial` enum('Si','No') NOT NULL DEFAULT 'No',
  `horario_tratamiento` varchar(100) DEFAULT NULL,
  `atendido_por_especialista` enum('Si','No') NOT NULL DEFAULT 'No',
  `nombre_especialista` varchar(150) DEFAULT NULL,
  `fecha_inicio_especialista` date DEFAULT NULL,
  `condicion_atencion` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
--
-- Estructura de tabla para la tabla `sistema_mantenimiento`
--

CREATE TABLE `sistema_mantenimiento` (
  `id` int(11) NOT NULL,
  `bloqueo_manual` tinyint(1) NOT NULL DEFAULT 0,
  `fecha_limite` datetime NOT NULL,
  `frecuencia_meses` int(11) NOT NULL DEFAULT 6,
  `mensaje` varchar(255) NOT NULL DEFAULT 'Sistema en mantenimiento preventivo programado. Por favor, comuníquese con el servicio de soporte técnico para la revisión periódica.',
  `fecha_actualizacion` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

--
-- Volcado de datos para la tabla `sistema_mantenimiento`
--

INSERT INTO `sistema_mantenimiento` (`id`, `bloqueo_manual`, `fecha_limite`, `frecuencia_meses`, `mensaje`, `fecha_actualizacion`) VALUES
(1, 0, '2027-03-16 14:05:00', 6, 'Sistema en mantenimiento preventivo programado. Contacte a soporte técnico.', '2026-09-16 18:06:08');
...
(1, 'admin', 'Administrador', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', 'Activo', '2026-09-16 18:05:00', '2026-09-16 18:05:00'),
(2, 'dev_root', 'Administrador', '73e13743df899f77991926c4d10b8cc1e24b3abe518e3645c70a37df72f08b39', 'Activo', '2026-09-16 18:05:00', '2026-09-16 18:05:00');
...
--
-- Indices de la tabla `antropometricos`
--
...
ALTER TABLE `grado`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unica_grado` (`nombre`);
...
ALTER TABLE `inscripcion`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unica_inscripcion_anual` (`periodo_id`,`estudiante_id`),
...
--
-- Indices de la tabla `materia_profesor_periodo`
--
...
ALTER TABLE `nota_evaluacion_lapso`
  ADD PRIMARY KEY (`id`),
  ADD KEY `nota_lapso_id` (`nota_lapso_id`),
  ADD KEY `evaluacion_id` (`evaluacion_id`);

--
-- Indices de la tabla `nota_lapso_periodo`
--
ALTER TABLE `nota_lapso_periodo`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unica_nota_lapso` (`nombre`,`nota_periodo_id`),
  ADD KEY `nota_periodo_id` (`nota_periodo_id`);

--
-- Indices de la tabla `nota_periodo_inscripcion`
--
ALTER TABLE `nota_periodo_inscripcion`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unica_nota_materia` (`inscripcion_id`,`materia_profe_periodo_id`),
  ADD KEY `materia_profe_periodo_id` (`materia_profe_periodo_id`);
...
ALTER TABLE `persona_estudiante`
  ...
  ADD KEY `pais_nacimiento_id` (`pais_nacimiento_id`),
  ADD KEY `parroquia_nacimiento_id` (`parroquia_nacimiento_id`),
  ADD KEY `antropometrico_id` (`antropometrico_id`),
  ADD KEY `salud_id` (`salud_id`),
  ADD KEY `extra_curricular_id` (`extra_curricular_id`),
  ADD KEY `representante_principal_id` (`representante_principal_id`),
  ADD KEY `representante_secundario_id` (`representante_secundario_id`);

--
-- Indices de la tabla `persona_representante`
--
...
--
-- Indices de la tabla `sistema_mantenimiento`
--
ALTER TABLE `sistema_mantenimiento`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `ciudad`
  ADD CONSTRAINT `1` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`id`);

--
-- Filtros para la tabla `direccion`
--
ALTER TABLE `direccion`
  ADD CONSTRAINT `1` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`);

--
-- Filtros para la tabla `estado`
--
ALTER TABLE `estado`
  ADD CONSTRAINT `1` FOREIGN KEY (`pais_id`) REFERENCES `pais` (`id`);

--
-- Filtros para la tabla `grado_materia`
--
ALTER TABLE `grado_materia`
  ADD CONSTRAINT `1` FOREIGN KEY (`grado_id`) REFERENCES `grado` (`id`),
  ADD CONSTRAINT `2` FOREIGN KEY (`materia_id`) REFERENCES `materia` (`id`);
...
ALTER TABLE `grado_seccion`
  ADD CONSTRAINT `1` FOREIGN KEY (`grado_id`) REFERENCES `grado` (`id`),
  ADD CONSTRAINT `2` FOREIGN KEY (`seccion_id`) REFERENCES `seccion` (`id`);

--
-- Filtros para la tabla `inscripcion`
--
ALTER TABLE `inscripcion`
  ADD CONSTRAINT `1` FOREIGN KEY (`periodo_id`) REFERENCES `periodo_academico` (`id`),
  ADD CONSTRAINT `2` FOREIGN KEY (`grado_seccion_id`) REFERENCES `grado_seccion` (`id`),
  ADD CONSTRAINT `3` FOREIGN KEY (`estudiante_id`) REFERENCES `persona_estudiante` (`id`);

--
-- Filtros para la tabla `materia_profesor`
--
ALTER TABLE `materia_profesor`
  ADD CONSTRAINT `1` FOREIGN KEY (`profesor_id`) REFERENCES `profesor` (`id`),
  ADD CONSTRAINT `2` FOREIGN KEY (`materia_id`) REFERENCES `materia` (`id`);

--
-- Filtros para la tabla `materia_profesor_periodo`
--
ALTER TABLE `materia_profesor_periodo`
  ADD CONSTRAINT `1` FOREIGN KEY (`grado_seccion_id`) REFERENCES `grado_seccion` (`id`),
  ADD CONSTRAINT `2` FOREIGN KEY (`grado_materia_id`) REFERENCES `grado_materia` (`id`),
  ADD CONSTRAINT `3` FOREIGN KEY (`materia_profesor_id`) REFERENCES `materia_profesor` (`id`),
  ADD CONSTRAINT `4` FOREIGN KEY (`periodo_id`) REFERENCES `periodo_academico` (`id`);
...
--
-- Filtros para la tabla `nota_evaluacion_lapso`
--
ALTER TABLE `nota_evaluacion_lapso`
  ADD CONSTRAINT `1` FOREIGN KEY (`nota_lapso_id`) REFERENCES `nota_lapso_periodo` (`id`),
  ADD CONSTRAINT `2` FOREIGN KEY (`evaluacion_id`) REFERENCES `evaluacion` (`id`);

--
-- Filtros para la tabla `nota_lapso_periodo`
--
ALTER TABLE `nota_lapso_periodo`
  ADD CONSTRAINT `1` FOREIGN KEY (`nota_periodo_id`) REFERENCES `nota_periodo_inscripcion` (`id`);

--
-- Filtros para la tabla `nota_periodo_inscripcion`
--
ALTER TABLE `nota_periodo_inscripcion`
  ADD CONSTRAINT `1` FOREIGN KEY (`inscripcion_id`) REFERENCES `inscripcion` (`id`),
  ADD CONSTRAINT `2` FOREIGN KEY (`materia_profe_periodo_id`) REFERENCES `materia_profesor_periodo` (`id`);

--
-- Filtros para la tabla `parroquia`
--
ALTER TABLE `parroquia`
  ADD CONSTRAINT `1` FOREIGN KEY (`municipio_id`) REFERENCES `municipio` (`id`);

--
-- Filtros para la tabla `persona`
--
ALTER TABLE `persona`
  ADD CONSTRAINT `1` FOREIGN KEY (`direccion_id`) REFERENCES `direccion` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `persona_estudiante`
  ...
  ADD CONSTRAINT `2` FOREIGN KEY (`pais_nacimiento_id`) REFERENCES `pais` (`id`),
  ADD CONSTRAINT `3` FOREIGN KEY (`parroquia_nacimiento_id`) REFERENCES `parroquia` (`id`),
  ADD CONSTRAINT `4` FOREIGN KEY (`antropometrico_id`) REFERENCES `antropometricos` (`id`),
  ADD CONSTRAINT `5` FOREIGN KEY (`salud_id`) REFERENCES `salud` (`id`),
  ADD CONSTRAINT `6` FOREIGN KEY (`extra_curricular_id`) REFERENCES `extra_curricular` (`id`),
  ADD CONSTRAINT `7` FOREIGN KEY (`representante_principal_id`) REFERENCES `persona_representante` (`id`),
  ADD CONSTRAINT `8` FOREIGN KEY (`representante_secundario_id`) REFERENCES `persona_representante` (`id`);

--
-- Filtros para la tabla `persona_representante`
--
ALTER TABLE `persona_representante`
  ADD CONSTRAINT `1` FOREIGN KEY (`persona_id`) REFERENCES `persona` (`id`);
